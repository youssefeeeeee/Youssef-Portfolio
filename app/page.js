...
export default function Home() {
  ...
  return (
    ...
    <section className="flex flex-col translate-y-20 items-center md:flex-row-reverse md:translate-y-10 md:translate-x-50   md:items-center  md:justify-between md:max-w-[900px]">
      ...
      >
      <Image src="/port pic.jpg" width={300} height={300} className="rounded-full w-[200px] h-[200px] md:w-[300px] md:h-[300px] mb-5" alt="pic" />
      </motion.div>
      ...
      >
      <p className="m-2  bg-stone-100 text-lg text-center md:text-2xl md:text-left">HI, I am Youssef, I am learning Next.js you can download the resume.</p>
      </motion.div>
      <motion.div
      initial={{ opacity: 0, y: 50 }}
      animate={splashseen ? { opacity: 1, y: 0 } : {}}           
