    ...
    <div >
      <Navbar/>
            <div className="absolute translate-x-230 -translate-y-60 max-w-400">
              ...
              <div className="m-2">
                <h1 className="text-gray-900 font-extrabold text-2xl mb-2 max-w-110 text-center">About Me</h1>
                <h2 className="text-gray-900 font-bold text-xl">Brief description : </h2>
